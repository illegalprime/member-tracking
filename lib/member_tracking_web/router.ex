defmodule MemberTrackingWeb.Router do
  use MemberTrackingWeb, :router
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {MemberTrackingWeb.Layouts, :root}
  ...
  scope "/", MemberTrackingWeb do
    ...
    live_session :member_authenticated,
      on_mount: [{MemberTrackingWeb.UserAuth, :ensure_authenticated}] do
      live "/", MembersLive
    end
  end
  ...
  if Application.compile_env(:member_tracking, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: MemberTrackingWeb.Telemetry
  ...
  scope "/", MemberTrackingWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{MemberTrackingWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", MemberTrackingWeb do
    ...
    live_session :current_user,
      on_mount: [{MemberTrackingWeb.UserAuth, :mount_current_user}] do
